...
<template>
   <div style="padding-bottom:70px;min-height:470px;">
     ...
     <div class="header f-df f-pr20">
       <div>
          <el-input placeholder="请输入负责人姓名\手机号码码\身份证" style="vertical-align:bottom"  @keyup.enter.native=getTableData v-model=findName class="input-with-select"  size="small">
          </el-input> 
