...
<template>
   <div style="padding-bottom:70px;min-height:470px;">
     ...
     <div class="header f-df f-pr20">
       <div>
          <el-select v-model="zldm" size="small" class="f-vab f-mr20" style="width:150px;" placeholder="请选择大类"   @change="getTableData;getTypes('NCPEJFL')">
            <el-option
              v-for="item in zldms"
              :key="item.sjzdBm"
              :label="item.sjzdMc"
          ...
          <el-select v-model="ej" size="small"   class="f-vab f-mr20" style="width:150px;" placeholder="请选择小类"  @change=getTableData({pageSize:10,pageNo:1})>
            <el-option
              v-for="item in ejs"
              :key="item.sjzdBm"
              :label="item.sjzdMc"
          ...
          <el-input placeholder="输入农产品名称" style="vertical-align:bottom"  @keyup.enter.native=getTableData v-model=ncpmc class="input-with-select"  size="small">
          </el-input> 
...
<script>
    ...
    export default {
        ...
        */
        getTableData(obj={}){
          this.loading = true;
          let {industryId,ncpmc,zldm,ej} = this;
          var params =  {
        ...
        getTypes(typeText){
          ...
          console.log("params");
          console.log(params);
          console.log(this.$fetch.api_base.cpwh_type);
