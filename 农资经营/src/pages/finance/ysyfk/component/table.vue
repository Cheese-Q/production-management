...
<template>
   <div class="dkfzr">
     ...
     <div class="header f-df f-pr20">
       <div>
          <el-input placeholder="请输入往来单位" @keyup.enter.native=search v-model=findName class="input-with-select f-vab"  size="small">
          </el-input> 
    ...
    export default {
        data(){
            return {
                ...
                //table参数
                tableHeader:[
                  {label:'单位名称',prop:'dxmc'},
                  {label:'应收款',prop:'ysje',width:'250'},
                  {label:'应付款',prop:'yfje',width:'250'},
                ],
                loading:false,
                totalCount:1,
                tableData: [],
