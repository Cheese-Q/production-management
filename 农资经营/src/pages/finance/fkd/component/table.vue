<!--
 * @Author: 龚铱白
 * @Date: 2019-08-12 10:23:18
 * @LastEditors: 龚铱白
 * @LastEditTime: 2019-08-15 10:27:19
 * @Description: 
 -->
/*商品信息*/
<template>
  <div class="dkfzr">
    ...
    <div class="header f-df f-pr20">
      <div>
        ...
        <el-input placeholder="请输入订单号/供应商名称"
    ...
    <el-table v-loading=loading
      ...
      <el-table-column prop="ywlx"
        ...
        <template slot-scope="scope">
          <!-- <div v-if="scope.row.ywlx==1">销售</div>
          <div v-if="scope.row.ywlx==2">零售</div> -->
          <div v-if="scope.row.ywlx==3">进货付款</div>
          <div v-if="scope.row.ywlx==4">销售退货</div>
          <div v-if="scope.row.ywlx==5">零售退货</div>
        </template>
      </el-table-column>
