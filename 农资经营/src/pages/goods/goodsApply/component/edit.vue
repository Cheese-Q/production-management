...
<template>
  <div class="addShopping">
    <el-form ref="form"
             ...
             :rules="rules"
             status-icon>
      <div class="form-title f-fs18 f-tac f-mb30 f-mt30">新增商品备案</div>
      ...
      <el-form-item label="规格" prop="spgg">
        <el-row>
          <el-col :span="18">
            <div>
              <el-input v-model="form.spgg" placeholder="请输入"></el-input>
            </div>
          </el-col>
          <el-col :span="6">
            <div>
      ...
      <el-form-item label="保质期(天)" prop="yxq">
  ...
  export default {
    ...
    methods: {
      ...
      getLx(val) {
        // this.getFenlei(val);
        let obj = {};
        obj = this.zldms.find((item)=>{
          return item.sjzdBm === val;//搜索类别名称
        });

        this.nzdlMc = obj.sjzdMc;
        this.sjbm = val;
        this.form.fenlei = "";
        this.form.spmc = "";
      },
      ...
      submitForm() {
        ...
        if(this.value != '' && this.value != undefined){
          this.form.spgg = this.form.spgg + this.value;
        }
