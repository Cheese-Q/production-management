 ...
 * @LastEditTime: 2019-09-03 16:31:58
 * @LastEditors: 龚铱白
 -->
/*编辑*/
<template>
    ...
    methods: {
      ...
      getinfo() {
        fetch({
          ...
          this.form.sfz = this.info.sfz;
          if (this.bizProvince != '' && this.bizProvince != null) {
            this.getTypes('sj');
          }
          if (this.bizCity != '' && this.bizCity != null) {
            this.getTypes('xj');
          }
          if (this.bizCounty != '' && this.bizCounty != null) {
            this.getTypes('xxj');
          }
          let cs = this.bizProvince + ' ' + this.bizCity + ' ' + this.bizCounty + ' ' + this.bizTown;
        }).catch(res => {
        });
      ...
      changeSelect() {
        ...
        for (let i = 0; i < lists.length; i++) {
          if (lists[i].id == this.form.hydjId) {
