 ...
 * @LastEditors: 龚铱白
 * @LastEditTime: 2019-07-30 09:05:09
 * @Description: 
 -->
/*商品信息*/
<template>
  <div class="dkfzr">
    ...
    <el-table v-loading=loading
      ...
      <el-table-column prop="cusName"
                       label="客户名称">
      </el-table-column>
      <el-table-column prop="zhjze"
                       label="订单总金额">
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    deleteSj (row) {
      console.log(row)
      this.$confirm("此操作将删除该条销售单信息, 是否继续?", "提示", {
    ...
    */
    ...
    getTableData (obj = {}) {
      ...
      this.$fetch.api_wholesale.xsck_list(params).then(res => {
