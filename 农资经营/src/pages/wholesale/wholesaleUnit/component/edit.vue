...
<template>
  <el-form ref="form" :model="form" label-width="100px" class="form" :rules="rules" status-icon>
    <div class="form-title f-fs18  f-tac f-mb30 f-mt30">{{form.id?'编辑':'新增'}}往来单位信息</div>
    <el-form-item label="单位名称" prop="bizName">
      <el-input v-model="form.bizName" placeholder="请输入"></el-input>
    </el-form-item>
    <el-form-item label="类型" prop="bizType">
      <el-select v-model="form.bizType" size="small" class="f-vab f-mr20" style="width:100%;" placeholder="请选择">
        <el-option
    ...
    <el-form-item label="类别" prop="supplierType">
      <el-select v-model="form.supplierType" size="small" class="f-vab f-mr20" style="width:100%;" placeholder="请选择">
        <el-option
          v-for="item in gystype"
          :key="item.key"
          :label="item.value"
          :value="item.key">
        </el-option>
    ...
    <el-form-item label="社会统一代码/身份证" prop="icCreditCode">
      <el-input v-model="form.icCreditCode" placeholder="请输入社会统一代码/身份证"></el-input>
    </el-form-item>
    <el-form-item label="联系人" prop="contPerson">
      <el-input v-model="form.contPerson" placeholder="请输入"></el-input>
    </el-form-item>
    <el-form-item label="联系电话" prop="contNumber">
      <el-input v-model="form.contNumber" placeholder="请输入"></el-input>
    </el-form-item>
    <el-form-item label="客户地址">
      <el-select
        ...
        prop="bizProvince"
        placeholder="省级地区" style="width: 24%;">
        <el-option
      ...
      <el-select
        ...
        prop="bizCity"
        placeholder="市级地区" style="width: 24%;">
        <el-option
          v-for="item in city"
          :key="item.qyId"
          :label="item.qymc"
      ...
      <el-select
        ...
        prop="bizCounty"
        placeholder="县级地区" style="width: 24%;">
        <el-option
      ...
      <el-select
        v-model="bizTown"
        prop="bizTown"
        placeholder="乡级地区" style="width: 24%;"  @change="checkaddress">
        <el-option
          v-for="item in town"
          :key="item.qyId"
          :label="item.qymc"
    ...
    <el-form-item prop="bizAddress">
      <el-input v-model="form.bizAddress" placeholder="请输入详细地址"></el-input>
    </el-form-item>

    <el-form-item label="备注">
      <el-input type="textarea" :autosize="{ minRows: 3, maxRows: 10}" v-model="form.comment"
  ...
  export default {
    data() {
      ...
      return {
        ...
        id:0,
        check:false,
        khtype: [{key:'1',value:'客户'},{key:'2',value:'供应商'},{key:'3',value:'客户和供应商'}],
      ...
      submitForm() {
        ...
        this.$refs.form.validate((valid) => {
          if (valid) {
            ...
            this.disabled = true;
            //新增字段
            let {bizName, bizType, supplierType, icCreditCode,contPerson,contNumber,comment,bizAddress} = this.form;
            //用户参数
            ...
            //传值参数
            let params = {id,bizName,bizAddress, bizType, supplierType, icCreditCode, bizId,contPerson,contNumber,comment,bizProvince,bizCity,bizCounty,bizTown,delFlag,createUserId};
