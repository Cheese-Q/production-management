        ...
        data(){
            return {
                ...
                tableHeader:[
                  ...
                  {label:'进场数量',prop:'zzl',width:'90'},
				  {label:'存栏数',prop:'cls',width:'90'},
                  {label:'调入数',prop:'drnum',width:'90'},
                  {label:'调出数',prop:'dcnum',width:'90'},
                  {label:'死亡数',prop:'swnum',width:'90'},
				  {label:'出栏数',prop:'xss',width:'90'},
				  {label:'状态',prop:'zt',width:'100','render-column':this.renderState},
