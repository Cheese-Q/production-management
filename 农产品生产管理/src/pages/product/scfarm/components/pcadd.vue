...
<template>
    <el-form ref="form" :model="form" label-width="120px" class="form cpwh-edit" :rules="rules" status-icon>
      ...
      <el-form-item label="放养日期" prop="zzrq" >
            <el-date-picker
        ...
        <el-form-item label="养殖面积(亩)" prop="zzmj">
        <el-input v-model.trim="form.zzmj" type="number" placeholder="请输入" :maxlength="10" show-word-limit></el-input>
      </el-form-item>
      <el-form-item label="养殖方式" prop="zzfs">
        <el-input v-model.trim="form.zzfs" placeholder="请输入" :maxlength="10" show-word-limit></el-input>
      </el-form-item>
      <el-form-item label="养殖量" prop="zzl">
  ...
  export default {
    ...
    methods: {
      ...
      selSample(row){
        ...
        // this.$refs.form.validateField('ncpmc');
