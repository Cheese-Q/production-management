...
<template>
  <el-form
    ...
    status-icon
  >
    <div class="form-title f-fs18 f-tac f-mb30 f-mt30">{{form.sfjlId?'编辑':'新增'}}投料信息</div>
    <el-form-item label="水塘名称">
      <el-input v-model.trim="this.pcInfo.cdmc" placeholder="请输入" disabled></el-input>
    </el-form-item>
    <el-form-item label="养殖产品">
      <el-input v-model.trim="this.pcInfo.ncpmc" placeholder="请输入" disabled></el-input>
    </el-form-item>
    <el-form-item label="投料日期" prop="sfrq">
      <el-date-picker
    ...
    <el-form-item label="用量(斤)" prop="yljff">
      <el-input v-model.trim="form.yljff" placeholder="请输入" :maxlength="20" show-word-limit></el-input>
    </el-form-item>
    <el-form-item label="投料人" prop="sfr">
      <el-input v-model.trim="form.sfr" placeholder="请输入" :maxlength="20" show-word-limit></el-input>
    </el-form-item>
    <el-form-item label="水温(℃)" prop="sw">
      <el-input v-model.trim="form.sw" placeholder="请输入" :maxlength="20" show-word-limit></el-input>
    </el-form-item>
    <el-form-item label="PH值" prop="phz">
      <el-input v-model.trim="form.phz" placeholder="请输入" :maxlength="20" show-word-limit></el-input>
    </el-form-item>
    <el-form-item label="增氧(h)" prop="zy">
      <el-input v-model.trim="form.zy" placeholder="请输入" :maxlength="20" show-word-limit></el-input>
    </el-form-item>
    <el-form-item label="盐度(‰)" prop="yd">
      <el-input v-model.trim="form.yd" placeholder="请输入" :maxlength="20" show-word-limit></el-input>
    </el-form-item>
    <el-form-item label="注水(cm)" prop="zs">
      <el-input v-model.trim="form.zs" placeholder="请输入" :maxlength="20" show-word-limit></el-input>
    </el-form-item>
    <el-form-item label="排水(cm)" prop="ps">
      <el-input v-model.trim="form.ps" placeholder="请输入" :maxlength="20" show-word-limit></el-input>
    </el-form-item>
    <el-form-item label="氨氮(mg/l)" prop="ad">
      <el-input v-model.trim="form.ad" placeholder="请输入" :maxlength="20" show-word-limit></el-input>
    </el-form-item>
