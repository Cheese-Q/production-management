...
<template>
  <el-form
    ...
    status-icon
  >
    <div class="form-title f-fs18 f-tac f-mb30 f-mt30">{{form.csjlId?'编辑':'新增'}}捕捞信息</div>
    ...
    <el-form-item label="捕捞日期" prop="csrq">
      <el-date-picker
    ...
    <el-form-item label="捕捞产品" prop="csncpmc">
      <el-select
    ...
    <el-form-item label="捕捞量" prop="csl" class="f4">
