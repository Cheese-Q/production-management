   ...
   <div class="dkfzr">
     ...
     <div class="header f-df f-pr20">
       <div>
          ...
          <el-input  placeholder="请输入地块名称\农产品\批次号"  @keyup.enter.native=search v-model.trim=searchkey class=" input-with-select f-vab"  size="small" clearable>
          </el-input> 
        ...
        data(){
            return {
                ...
                tableHeader:[
                  ...
                  {label:'种植日期',prop:'zzrq'},
                  {label:'地块名称',prop:'cdmc'},
                  {label:'种植作物',prop:'ztncpmc'},
				  {label:'种植批次',prop:'zzpc'},
                  {label:'种植面积(亩)',prop:'zzmj'},
                  {label:'种植量(每亩)',prop:'zzl'},
				  {label:'状态',prop:'zt','render-column':this.renderState},
