   ...
   <div class="dkfzr">
     ...
     <div class="header f-df f-pr20">
       <div>
          ...
          <label>状态</label>
          <el-select  v-model.trim="type" size="small" class=" f-mr20 f-vab" placeholder="请选择"  style="vertical-align:bottom" @change=search>
            <el-option value="" label="全部"></el-option>
            <el-option value="1" label="未完结"></el-option>
            <el-option value="2" label="已完结"></el-option>
         </el-select>
          <el-input  placeholder="请输入地块名称\农产品\批次号"  @keyup.enter.native=search v-model.trim=searchkey style="vertical-align:bottom" class=" input-with-select f-vab"  size="small" clearable>
          </el-input> 
    ...
    export default {
        data(){
            return {
                ...
                //种植业
                tableHeader:[
                  {label:'起批日期',prop:'qprq',width:'150'},
                  {label:'种植日期',prop:'zzrq',width:'150'},
                  {label:'地块名称',prop:'cdmc'},
                  {label:'种植作物',prop:'ncpmc'},
				  {label:'种植批次',prop:'zzpc',width:'200'},
                  {label:'种植面积(亩)',prop:'zzmj',width:'150'},
				  {label:'状态',prop:'zt',width:'150','render-column':this.renderState},
                  {label:'操作',prop:'sfky',width:'150','render-column':this.renderEdit}
                ],
                loading:false,
                totalCount:1,
                tableData: [],
