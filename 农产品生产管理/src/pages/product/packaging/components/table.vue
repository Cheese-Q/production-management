    ...
    export default {
       ...
       /*render-column开始*/
        ...
        renderTrpEdit(h,row){
          return (
            <div>
                <el-button size="mini" type="info" plain plainclass="edit" onClick={()=>{this.$emit('edit',row,'1')}}>编辑</el-button> 
                <el-button size="mini" plain onClick={()=>{this.$emit('edit',row,'1','info')}}>查看</el-button> 
            </div>
          )
        },
        renderXzEdit(h,row){
