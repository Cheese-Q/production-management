   ...
   <div class="dkfzr">
     ...
     <div class="header f-df f-pr20">
      ...
      <div class="f-f1 f-tar">
		...
		<el-button type="primary" size="medium" @click="$emit('edit',{},'single')" round style="padding:9px 25px">散买提货</el-button>
		<el-button type="primary" size="medium" @click="$emit('edit',{},'multi')" round style="padding:9px 25px">批发提货</el-button>
      </div>
    </div> 
     <s-table
        v-loading=loading
    ...
    export default {
        ...
        data(){
            return {
                ...
                //table参数
                tableHeader:[
                  {label:'采购日期',prop:'jhrq',width:'150'},
                  {label:'订单号',prop:'jhdh',width:'200'},
                  {label:'供应商单位',prop:'ghsmc'},
