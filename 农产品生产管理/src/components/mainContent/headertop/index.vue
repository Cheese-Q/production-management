  ...
  <div id="app-head" class="f-select-not">
    ...
    <el-dialog
      ...
      <div class="f-xy" style="height: 600px;overflow-y: auto;">
        <p>
          根据《中华人民共和国农产品质量安全法》、《丽水市农业局关于印发丽水市农业生产领域农产品质量安全追溯管理实施方案的通知》（丽农发〔2014〕0036号）、
          《丽水市人民政府办公室关于丽水市农产品质量安全溯源体系建设的实施意见》（丽政办法〔2014〕126号）及《“丽水山耕”区域公用品牌商标使用管理实施细则》等的相关规定，
          甲乙双方遵循自愿、诚实、信用原则，协商一致，签订该协议。
        </p>
        <p>
          “丽水山耕”农产品质量安全溯源平台是丽水市委市政府委托丽水市农业投资发展有限公司开发的“丽水山耕”管理系统的其中一个平台，甲方是该溯源平台的知识产权拥有者。
        </p>
        <p>一、合同期限</p>
        ...
        <p>7.合同终止的。</p>
        <p>五、争议解决</p>
        <p>在履行本合同过程中发生的争议，由双方协商解决，协商不成的情况下提交丽水市莲都区人民法院管辖。</p>
        <p>六、其他</p>
